...
import { selectModel } from "@/store/aiSlice"; // Import selectModel
...
// import DuinoPrimeLogo1 from "../../../public/svgs/duino-prime/logo1.svg";
// import DuinoPrimeLogo2 from "../../../public/svgs/duino-prime/logo2.svg";
import DuinoUMILogo1 from "../../../public/svgs/duino-umi/EST.svg";
import DuinoUMILogo2 from "../../../public/svgs/duino-umi/UMI.svg";
// import WormDuinoLogo1 from "../../../public/svgs/worm-duino/logo1.svg";
// import WormDuinoLogo2 from "../../../public/svgs/worm-duino/logo2.svg";
...
const MainPrompt = () => {
  ...
  const aiModel = useSelector(selectModel); // Get the selected AI model
...
useEffect(() => {
  ...
  switch (aiModel) {
    case "Duino-Prime":
      backgroundStyle = "radial-gradient(circle at center, #fc466b,#fd1d1d,  #94bbe9)";
      logoSVGs = [
        DuinoUMILogo1, 
        DuinoUMILogo2,
      ];
    ...
    case "Worm-Duino":
      backgroundStyle = "radial-gradient(circle at center, rgb(0, 128, 128), rgb(0, 80, 80)";
      logoSVGs = [
        DuinoUMILogo1, 
        DuinoUMILogo2, 
      ];
    ...
    default:
      backgroundStyle = "radial-gradient(circle at center, #fc466b,#fd1d1d";
      logoSVGs = []; 
  }
  ...
  const handleClick = () => {
    ...
    setSloganText(""); // Reset text for the new slogan
  };
  ...
  return (
    <div className={styles.container} style={{ background: background }}>
      ...
      <div className={styles.promptContainer}>
        <textarea
          placeholder="Ask Duino Anything(Enter to submit)..."
        ...
        <div className={styles.mainRow}>
          <div className={styles.sectionRow}>
            ...
            <div className={styles.button} onClick={handleModal} id="attachButton">
              {loading ? (
